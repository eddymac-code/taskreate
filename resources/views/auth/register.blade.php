                        ...
                        <form method="POST" action="">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                     name="email" value="{{ old('email') }}" placeholder="Enter your email address" required autocomplete="email">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    name="password" placeholder="Enter your chosen password" required autocomplete="new-password">
